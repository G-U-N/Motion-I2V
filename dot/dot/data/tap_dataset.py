...
class TapVid(Dataset):
    def __init__(
        self, data_root, split="davis", query_mode="first", resize_to_256=True
    ):
        self.split = split
    ...
    def __getitem__(self, index):
        ...
        rgbs = torch.from_numpy(frames).permute(0, 3, 1, 2).float() / 255.0
        ...
        data = {"video": rgbs, "query_points": query_points, "tracks": tracks}
