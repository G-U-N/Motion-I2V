...
class DemoOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            nargs="+",
            default=["overlay", "spaghetti_last_static"],
        )
        parser.add_argument("--video_path", type=str, default="orange.mp4")
        parser.add_argument("--mask_path", type=str, default="orange.png")
        parser.add_argument(
            "--save_tracks", type=str2bool, nargs="?", const=True, default=False
        )
        parser.add_argument(
            "--recompute_tracks", type=str2bool, nargs="?", const=True, default=False
        )
        ...
        parser.add_argument(
            "--save_mode", type=str, default="video", choices=["image", "video"]
        )
