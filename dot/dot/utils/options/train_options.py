...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument("--log_factor", type=float, default=1.0)
        ...
        parser.add_argument("--lambda_motion_loss", type=float, default=1.0)
        parser.add_argument("--lambda_visibility_loss", type=float, default=1.0)
        parser.add_argument("--optimizer_path", type=str, default=None)
        parser.set_defaults(
            data_root="datasets/kubric/movi_f",
            name="train",
            batch_size=8,
            refiner_path=None,
            is_train=True,
